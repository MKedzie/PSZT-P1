...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public Drawer() {
        ...
        drawingPanel.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                drawMapOnPanel(drawingPanel.getSize().width, drawingPanel.getSize().height, graphics);
            }
        });
    }
    ...
    private void drawMapOnPanel(int sizeX, int sizeY, Graphics g) {
        int mapSizeX = this.map.getMapSizeX();
        int mapSizeY = this.map.getMapsizeY();
        // sekcja rysowania linii
        ...
        for (int i = 0; i <= mapSizeY; i++)
            graphics2D.drawLine(0, horizontalLinesSpaceBetween * i, sizeX, horizontalLinesSpaceBetween * i);
        // teraz pionowe - x const i y1 y2 min max
        int verticalLinesSpaceBetween = sizeX / mapSizeX;
        for (int i = 0; i <= mapSizeX; i++)
            graphics2D.drawLine(verticalLinesSpaceBetween * i, 0, verticalLinesSpaceBetween * i, sizeY);
        graphics2D.drawImage(imageToDraw, 0, 0, this.drawingPanel);
